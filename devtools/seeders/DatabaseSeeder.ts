...
async function seedDatabase() {
    ...
    await em.begin();
    const reorderedTableNames = bringForthArrayElements(tableNames, ["language", "user", "profile", "collection", "attribution_source", "dictionary", "translation_language", "map_learner_language", "text", "vocab"]);
