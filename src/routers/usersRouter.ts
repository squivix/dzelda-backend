...
export const userRouter: FastifyPluginCallback = function (fastify, options, done) {
    ...
    fastify.put(`/users/me/password/`, {preHandler: [requiresAuth, requiresUnbannedAccount, requiresEmailConfirmed], handler: userController.changeUserPassword, config: {rateLimit: {max: 10, timeWindow: "1m"}}});
