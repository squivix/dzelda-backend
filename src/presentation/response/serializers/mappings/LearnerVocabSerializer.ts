    ...
    definition(vocabOrMapping: Vocab | MapLearnerVocab): CustomCallbackObject<Partial<LearnerVocabSchema>> {
        ...
        if (vocabOrMapping instanceof Vocab) {
            ...
            return {
                ...
                learnerMeanings: () => [],
                meanings: () => meaningSerializer.serializeList(vocabOrMapping.meanings.getItems()) as MeaningSchema[]
            };
        } else {
            return {
                ...
                learnerMeanings: () => meaningSerializer.serializeList(vocabOrMapping.vocab.learnerMeanings.getItems(), {ignore: ["vocab"]}) as MeaningSchema[],
                meanings: () => meaningSerializer.serializeList(vocabOrMapping.vocab.meanings.getItems(), {ignore: ["vocab"]}) as MeaningSchema[]
            };
        }
    }
