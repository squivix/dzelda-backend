...
export class Migration20230831152604 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "email_confirmation_token" ("id" serial primary key, "token" varchar(255) not null, "expires_on" timestamptz(0) not null default now() + interval \'1 hour\', "user_id" int not null);');
