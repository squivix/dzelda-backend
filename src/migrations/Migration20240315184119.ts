...
export class Migration20240315184119 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "attribution_source" ("id" serial primary key, "name" varchar(255) not null, "url" varchar(255) null, "logo_url" varchar(255) null);');
    ...
    this.addSql('create table "human_pronunciation" ("id" serial primary key, "url" varchar(500) not null default \'\', "text" varchar(255) not null, "parsed_text" varchar(255) not null, "language_id" int not null, "speaker_country_code" varchar(255) null, "speaker_region" varchar(255) null, "attribution_source_id" int null, "attribution" jsonb null);');
    this.addSql('create index "human_pronunciation_attribution_source_id_index" on "human_pronunciation" ("attribution_source_id");');
    this.addSql('create index "human_pronunciation_language_id_index" on "human_pronunciation" ("language_id");');
    ...
    this.addSql('create index "tts_voice_language_id_index" on "tts_voice" ("language_id");');
    ...
    this.addSql('create index "map_learner_language_preferred_tts_voice_id_index" on "map_learner_language" ("preferred_tts_voice_id");');
    ...
    this.addSql('create index "text_added_by_id_index" on "text" ("added_by_id");');
    this.addSql('create index "text_language_id_index" on "text" ("language_id");');
    ...
    this.addSql('create index "file_upload_request_user_id_index" on "file_upload_request" ("user_id");');
    ...
    this.addSql('create index "tts_pronunciation_vocab_id_index" on "tts_pronunciation" ("vocab_id");');
    this.addSql('create index "tts_pronunciation_voice_id_index" on "tts_pronunciation" ("voice_id");');

    this.addSql('create table "meaning" ("id" serial primary key, "text" varchar(500) not null, "vocab_id" int not null, "added_by_id" int null, "added_on" timestamptz not null default now(), "attribution_source_id" int null, "attribution" jsonb null, "language_id" int not null);');
    this.addSql('create index "meaning_attribution_source_id_index" on "meaning" ("attribution_source_id");');
    ...
    this.addSql('create table "map_vocab_root_form" ("id" serial primary key, "vocab_id" int not null, "root_form_id" int not null);');
    this.addSql('create index "map_vocab_root_form_vocab_id_index" on "map_vocab_root_form" ("vocab_id");');
    this.addSql('create index "map_vocab_root_form_root_form_id_index" on "map_vocab_root_form" ("root_form_id");');
    this.addSql('alter table "map_vocab_root_form" add constraint "map_vocab_root_form_vocab_id_root_form_id_unique" unique ("vocab_id", "root_form_id");');
    ...
    this.addSql('create table "vocab_tag_category" ("id" serial primary key, "name" varchar(255) not null);');

    this.addSql('create table "vocab_tag" ("id" serial primary key, "name" varchar(255) not null, "category_id" int null);');
    this.addSql('create index "vocab_tag_category_id_index" on "vocab_tag" ("category_id");');

    this.addSql('create table "map_vocab_tag" ("id" serial primary key, "tag_id" int not null, "vocab_id" int not null);');
    this.addSql('create index "map_vocab_tag_vocab_id_index" on "map_vocab_tag" ("vocab_id");');
    this.addSql('create index "map_vocab_tag_tag_id_index" on "map_vocab_tag" ("tag_id");');
    this.addSql('alter table "map_vocab_tag" add constraint "map_vocab_tag_tag_id_vocab_id_unique" unique ("tag_id", "vocab_id");');
    ...
    this.addSql('alter table "human_pronunciation" add constraint "human_pronunciation_attribution_source_id_foreign" foreign key ("attribution_source_id") references "attribution_source" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "meaning" add constraint "meaning_attribution_source_id_foreign" foreign key ("attribution_source_id") references "attribution_source" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "map_vocab_root_form" add constraint "map_vocab_root_form_vocab_id_foreign" foreign key ("vocab_id") references "vocab" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "map_vocab_root_form" add constraint "map_vocab_root_form_root_form_id_foreign" foreign key ("root_form_id") references "vocab" ("id") on update cascade on delete cascade;');
    ...
    this.addSql('alter table "vocab_tag" add constraint "vocab_tag_category_id_foreign" foreign key ("category_id") references "vocab_tag_category" ("id") on update cascade on delete set null;');

    this.addSql('alter table "map_vocab_tag" add constraint "map_vocab_tag_tag_id_foreign" foreign key ("tag_id") references "vocab_tag" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "map_vocab_tag" add constraint "map_vocab_tag_vocab_id_foreign" foreign key ("vocab_id") references "vocab" ("id") on update cascade on delete cascade;');
  }

  async down(): Promise<void> {
    this.addSql('alter table "human_pronunciation" drop constraint "human_pronunciation_attribution_source_id_foreign";');

    this.addSql('alter table "meaning" drop constraint "meaning_attribution_source_id_foreign";');
    ...
    this.addSql('alter table "map_vocab_root_form" drop constraint "map_vocab_root_form_vocab_id_foreign";');

    this.addSql('alter table "map_vocab_root_form" drop constraint "map_vocab_root_form_root_form_id_foreign";');
    ...
    this.addSql('alter table "map_vocab_tag" drop constraint "map_vocab_tag_vocab_id_foreign";');

    this.addSql('alter table "map_learner_meaning" drop constraint "map_learner_meaning_meaning_id_foreign";');

    this.addSql('alter table "vocab_tag" drop constraint "vocab_tag_category_id_foreign";');

    this.addSql('alter table "map_vocab_tag" drop constraint "map_vocab_tag_tag_id_foreign";');

    this.addSql('drop table if exists "attribution_source" cascade;');
    ...
    this.addSql('drop table if exists "map_vocab_root_form" cascade;');

    this.addSql('drop table if exists "map_text_vocab" cascade;');

    this.addSql('drop table if exists "map_learner_vocab" cascade;');

    this.addSql('drop table if exists "vocab_tag_category" cascade;');

    this.addSql('drop table if exists "vocab_tag" cascade;');

    this.addSql('drop table if exists "map_vocab_tag" cascade;');
  }
